...
const SYSROOT_LIBS = path self ./sysroot-libs.cmake
...
export def configure []: nothing -> nothing {
  ...
  let defs = ({
    ...
    # find_library results inside the sysroot become -l / -framework
    CMAKE_PROJECT_TOP_LEVEL_INCLUDES: $SYSROOT_LIBS
    PKGS_SYSROOT: $c.platform.sysroot
